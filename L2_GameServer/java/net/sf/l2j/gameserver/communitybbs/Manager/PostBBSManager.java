...
public class PostBBSManager extends BaseBBSManager
{
	...
	private void showHtmlEditPost(Topic topic, L2PcInstance activeChar, Forum forum, Post p)
	{
		...
		html.append("<td align=center FIXWIDTH=70><button value=\"&$140;\" action=\"Write Post " + forum.getID() + ";" + topic.getID()
	...
	private void showMemoPost(Topic topic, L2PcInstance activeChar, Forum forum)
	{
		...
		html.append("<td FIXWIDTH=300></td><td><button value = \"&$424;\" action=\"bypass _bbsposts;edit;" + forum.getID() + ";" + topic.getID()
