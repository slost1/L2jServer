...
public final class Config
{
    ...
    public static boolean UPDATE_ITENS_ON_CHAR_STORE;
    
    /** Update itens only when strictly necessary */
    public static boolean LAZY_ITENS_UPDATE;
    ...
    public static void load()
    {
        if(Server.serverMode == Server.MODE_GAMESERVER)
        {
            ...
            try
            {
                ...
                UPDATE_ITENS_ON_CHAR_STORE = Boolean.parseBoolean(optionsSettings.getProperty("UpdateItensOnCharStore", "true"));
                
                LAZY_ITENS_UPDATE          = Boolean.parseBoolean(optionsSettings.getProperty("LazyItensUpdate", "true"));
